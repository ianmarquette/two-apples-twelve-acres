...
<?php if ( have_comments() ) : ?>
	<h3 id="comments" class="h2"><?php comments_number(__('<span>No</span> Responses', 'bonestheme'), __('<span>One</span> Response', 'bonestheme'), _n('<span>%</span> Response', '<span>%</span> Responses', get_comments_number(),'bonestheme') );?></h3>
...
<section id="respond" class="respond-form">
	...
	<ul id="comment-form-elements" class="clearfix">
		...
		<li>
			...
			<input type="url" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" placeholder="<?php _e('URL (optional)', 'bonestheme'); ?>" tabindex="3" />
		</li>
	...
	<p><textarea name="comment" id="comment" placeholder="<?php _e('Your Comment', 'bonestheme'); ?>" tabindex="4"></textarea></p>
